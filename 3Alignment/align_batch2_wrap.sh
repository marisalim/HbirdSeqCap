...
perl /pylon5/bi4iflp/mlim/SeqCapData/5-Alignment -f /pylon5/bi4iflp/mlim/SeqCapData/species_ref_files/Cviolifer_reffasta/ref_cviol_targetedRegionAndFlanking.fasta -r /pylon5/bi4iflp/mlim/SeqCapData/ScrubReads_Results/files_to_align/Cviol_readstoalign -o /pylon5/bi4iflp/mlim/SeqCapData/Novoalign_outs/novo_cviol -G $GATK_HOME/GenomeAnalysisTK.jar -P $PICARD_HOME/picard.jar -c 0 -k 0 -m 1 -i 250 -v 100 -l 151 -t 180 
