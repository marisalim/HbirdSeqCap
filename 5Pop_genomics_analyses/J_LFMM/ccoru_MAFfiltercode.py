...
##1. MAF file changes:
#zcat ccoru97_optP95_out.mafs.gz | tail -n +2 | awk '{print $1"_"$2"\t"$7}' > ccoru97_optP95_out_FILTER.mafs
##2. GENOfile changes:
#zcat ccoru97_optP95_out.geno.gz | awk '{print $1"_"$2}' > ccoru97_contigsite.txt
#gunzip ccoru97_optP95_out.geno.gz
#paste ccoru97_contigsite.txt ccoru97_optP95_out.geno > ccoru97_optP95_out_FILTER.geno

# FILE NAMES
# File1 (input mafs file): 'ccoru97_optP95_out_FILTER.mafs'
# File2 (input geno file): 'ccoru97_optP95_out_FILTER.geno'
# File3 (output filtered geno file): 'MAFfiltered_ccoru97_out.csv'
...
maf_counter1 = 0
maf_counter2 = 0
with open('ccoru97_optP95_out_FILTER.mafs', 'r') as maf:
	for line in maf:
...
counter = 0
counter2 = 0
with open('ccoru97_optP95_out_FILTER.geno', 'r') as genofile:
...
df_geno.to_csv('MAFfilteredgeno_ccoru97_out.csv', index=False, header=False)
