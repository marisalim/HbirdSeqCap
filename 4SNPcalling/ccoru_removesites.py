...
small_file = open('/pylon5/bi4iflp/mlim/SeqCapData/Novoalign_outs/ccoru_sites_to_keep.keep2','r')
long_file = open('/pylon5/bi4iflp/mlim/SeqCapData/Novoalign_outs/ccoru_combined_sites_to_remove.txt2','r')
output_file = open('/pylon5/bi4iflp/mlim/SeqCapData/Novoalign_outs/ccoru.keep','w')
